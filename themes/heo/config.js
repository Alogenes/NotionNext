const CONFIG = {
  ...
  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: 'Compartir',
  HERO_TITLE_2: 'Desarrollar',
  HERO_TITLE_3: 'Alogenes.eu.org',
  HERO_TITLE_4: 'Nuevo estilo',
  HERO_TITLE_5: 'Suscribe mi canal de Youtube',
  HERO_TITLE_LINK: 'https://www.youtube.com/channel/UC879X_Bo6g8V2BDnhWlVa8Q',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: 'Estudios', url: '/tag/Estudios' },
  HERO_CATEGORY_2: { title: 'Noticias', url: '/tag/Noticias' },
  HERO_CATEGORY_3: { title: 'Útiles', url: '/tag/Útiles' },

  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多六篇文章; 若留空白''，则推荐最近更新文章
  HERO_RECOMMEND_POST_TAG: 'Recomenda',
  ...
  INFO_CARD_URL: 'https://www.youtube.com/channel/UC879X_Bo6g8V2BDnhWlVa8Q', // 个人资料底部按钮链接
