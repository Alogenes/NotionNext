...
const BLOG = {
  ...
  GREETING_WORDS:
   ...
   'Este pagina está en actualización, tarda 1 mes de actualización'/* 'Hi，soy Jinou, Gracias por tu visitas,Bienvenido a mi blog🎉, Hi，soy Jinou, Gracias por tu visitas,Bienvenido a mi blog🎉'*/,
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Soy una persona', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://alogenes.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Alógenes,Blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jwu1210@g.educaand.es', // 邮箱地址 例如mail@tangly1024.com
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
...

    {
      name: '-怪绮谈-不思議の国のiアリス',
      artist: 'ZUN',
      url: 'http://ws.stream.qqmusic.qq.com/C400002Yg0Nf4B0MpW.m4a?guid=550890811&vkey=BB0F7A1C19B8C93E513681D3AEC5EEA6506EF9023A481933880D5FF56ACFF651A1D7F6CC1AFCBF6C269FD58EC591CB347B702CB246E5E29C&uin=&fromtag=120032&src=C400003CxXnL1kqTPs.m4a',
      cover:
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Alógenes´ BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Hello everyone', // 站点描述，被notion中的页面描述覆盖
